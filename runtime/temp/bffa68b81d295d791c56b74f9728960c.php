<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/www/wwwroot/lv.wyc168.com/public/../application/h5/view/user/info_bind.html";i:1558339878;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<header class="mui-bar mui-bar-nav  index-headers">
    ...
    <h1 class="mui-title color">我的信息</h1>
        ...
        <div class="mui-table-view mui-table-view-chevron  jihuo_card " >
            <form class="mui-input-group">
                ...
                <?php if($bind == 1): ?>
                    <div class="mui-input-row">
                        <label>姓名</label>
                        <input type="text" class="mui-input-clear" name="name" value="<?php echo $info->name; ?>" placeholder="请输入姓名">
                    </div>
                    <div class="mui-input-row">
                        <label>身份证号</label>
                        <input type="text" class="mui-input-clear" name="name_id" value="<?php echo $info->name_id; ?>" placeholder="请输入身份证号">
                    </div>
                    <div class="mui-input-row">
                        <label>手机号</label>
                        <input type="tel" class="mui-input-clear" name="mobile" value="<?php echo $info->mobile; ?>" placeholder="请输入手机号">
                    </div>
                    <div class="mui-input-row">
                        <label>省/市/区</label>
                        <input type="text" name="addr" id='showCityPicker3' value="<?php echo $info->addr; ?>" readonly  placeholder="请选择省市区">
                    </div>
                    <div class="mui-input-row">
                        <label>详细地址</label>
                        <textarea name="xiangxi"  placeholder="请选择详细地址"><?php echo $info->xiangxi; ?></textarea>
                    </div>
                <?php else: ?>
                    <div class="mui-input-row">
                        <label>姓名</label>
