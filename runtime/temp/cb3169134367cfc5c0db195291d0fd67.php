<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/lv.wyc168.com/public/../application/h5/view/alipay/pay.html";i:1558429405;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8"
...
<script>
    if (location.hash.indexOf('error') != -1) {
        ...
        if (ua.indexOf('micromessenger') != -1) {
            ...
            location.href = param != '' ? _AP.decode(param) : 'http://lv.wyc168.com/h5/alipay/pay.htm#error';
        }
    }
</script>
</body>
