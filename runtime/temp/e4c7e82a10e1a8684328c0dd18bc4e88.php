<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/www/wwwroot/lv.wyc168.com/public/../application/h5/view/trip/tjdetail.html";i:1558231292;s:65:"/www/wwwroot/lv.wyc168.com/application/h5/view/public/header.html";i:1558149238;s:65:"/www/wwwroot/lv.wyc168.com/application/h5/view/public/footer.html";i:1558340461;}*/ ?>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="mui-table-view mui-table-view-chevron  jingqu_shop  " style="background: #eff3f6;">
			<div class="swiper-container ">
				<div class="swiper-wrapper">
					 ...
					 <div class="swiper-slide"><a href="jingqu_shop.html"><img src="<?php echo $bo->image; ?>" ></a></div>
            ...
            <div class="jingqu_center">
                <h3 class="mui-ellipsis"><?php echo $info->title; ?>
                    <span class="mui-pull-right">
								<?php $__FOR_START_1538770123__=0;$__FOR_END_1538770123__=$info->star;for($i=$__FOR_START_1538770123__;$i < $__FOR_END_1538770123__;$i+=1){ ?>
                ...
                <div class="mui-ellipsis"><i class="fa fa-user"></i><?php echo $journey->max_people_count; ?>人  <a href="tel:<?php echo $journey->mobile; ?>"    class="mui-pull-right mui-btn" style=' background: #f29b76;color: #fff;border:none;'>电话咨询</a></div>
            </div>
            <div class="jingqu_bt">
