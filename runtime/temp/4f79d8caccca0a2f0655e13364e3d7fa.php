                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" >
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td><?php echo $vo->name_id; ?></td>
                                            <td><?php echo $vo->cash; ?></td>
                                            <td><?php echo $vo->people_count; ?></td>
                                            <td><?php echo $vo->sj_card_num; ?></td>
                                            <td><?php echo $vo->fukuan_time; ?></td>
                                            <td><a  data-toggle="modal" data-target="#myModal" onclick="neirong(<?php echo $vo->id; ?>)">查看详情</a></td>
                                            <td><?php echo $vo->w_state; ?></td>
                                            <td>
                                                <?php if($vo->state == 1): ?>
                                                <a href="javascript:;" onclick="chongzhi(<?php echo $vo->id; ?>)" id="demo3"   class="btn btn-sm btn-success">确认</a>
                                                <a href="javascript:;" onclick="bohui(<?php echo $vo->id; ?>)" id="demo3"   class="btn btn-sm btn-danger">驳回</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
...
<script type="text/javascript">
    ...
    function bohui(id) {
        layer.confirm('确定要驳回用户的充值吗？', {
            ...
            ajax_Submit("<?php echo url('chongzhi/bohui'); ?>", 'id=' + id, 'get')
        })
    }
    ...
    function chongzhi(id) {
        layer.confirm('确定通过审核？', {
            ...
            ajax_Submit("<?php echo url('order/queren'); ?>", 'id=' + id, 'get')
        })
    }
    ...
    function neirong(oid){
        $('#infos').empty()
        $.ajax({
            url:"<?php echo url('order/getOrderPeople'); ?>",
            data:'oid='+oid,
            dataType:'json',
            type:'get',
