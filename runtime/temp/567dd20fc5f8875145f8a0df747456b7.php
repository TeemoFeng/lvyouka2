<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/lv.wyc168.com/public/../application/h5/view/vipcard/payInfo.html";i:1558426972;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
...
<div class="wrapper-list">
        ...
        <dd>
            <dl>
                <dd class="kv-line-r dd-padding">
                    <h6>购买数量：</h6>
                    <p><?php echo $order['buy_num']; ?></p>
                </dd>
                <dd class="kv-line-r dd-padding">
                    <h6>单价：</h6>
                    <p><?php echo $order['one_price']; ?>元</p>
                </dd>
                <dd class="kv-line-r dd-padding">
                    <h6>总额：</h6>
                    <p>
                        <strong class="color-stronger highlight-price"><?php echo $total_amount; ?>元</strong>
                    </p>
                </dd>
            </dl>
        </dd>
    ...
    <div id="pay-methods-panel" class="pay-methods-panel">
        <div class="wrapper buy-wrapper">
            ...
            <a href="<?php echo $result; ?>" class="J-btn-submit btn mj-submit btn-strong btn-larger btn-block">确认支付</a>
        </div>
    </div>
</div>
<script type="text/javascript" src="/static/h5/js/ap.js"></script>
<script>
