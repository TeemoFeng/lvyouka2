<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/wwwroot/lv.wyc168.com/public/../application/h5/view/vipcard/card_make_out.html";i:1558206606;}*/ ?>
<html>
                ...
                <form class="">
                    ...
                    <div class="mui-input-row flex">
                        ...
                        <div class=" mui-radio mui-left">
                            <label style="width: 120px;padding-left: 26px;"><?php echo $co->title; ?></label>
