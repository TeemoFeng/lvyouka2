                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-body">
                            <a href="<?php echo url('scenic/scenicadd'); ?>" class="btn  btn-success">新增</a>
                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td><?php echo $vo->appoint_people; ?></td>
                                            <td><?php echo $vo->w_status; ?></td>
                                            <td>
                                                <a href="<?php echo url('scenic/scenicedit',['id'=>$vo->id]); ?>}}" class="btn btn-sm btn-success">编辑</a>
                                                ...
                                                <a href="<?php echo url('journey/journeyAdd',['id'=>$vo->id, 'category_id' => $vo['category_id']]); ?>"  class="btn  btn-success btn-sm">添加行程</a>
                                                <a href="<?php echo url('journey/journeyList2',['id'=>$vo->id]); ?>"  class="btn  btn-primary btn-sm">行程管理</a>
                                                <a href="<?php echo url('special/specialAdd',['id'=>$vo->id]); ?>"  class="btn  btn-primary btn-sm">设为特价线路</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </tbody>
...
<script type="text/javascript">
    ...
    function updateStatus(key = '',status = 1) {
        modifyByKeys("<?php echo url('scenic/scenicStatusUpdate'); ?>",key,status)
    }
   highlight_subnav();
