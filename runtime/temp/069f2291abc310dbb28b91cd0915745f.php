                        ...
                        <div class="ibox-content clearfix">
                            <form method="post" id="newsinfo" class="form-horizontal col-lg-6">
                                <div class="form-group"><label class="col-sm-2 control-label">*标题</label>
                                    <div class="col-sm-10"><input value="<?php echo $info->title; ?>" type="text" class="form-control" name="title"><span class="help-block m-b-none text-danger">(标题最长32个字符)</span></div>
                                </div>
...
<script type="text/javascript">
  ...
  highlight_subnav();
    function highlight_subnav() {
        ...
        $($('.metismenu li ').find('a[href="/wycadmin/vehicle/vehiclelist"]')).parent().addClass('active');
      
       $($('.metismenu li ').find('a[href="/wycadmin/vehicle/vehiclelist"]')).parent().parent().parent().addClass('active');
    }
