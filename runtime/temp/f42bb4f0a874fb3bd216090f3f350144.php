<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/www/wwwroot/lv.wyc168.com/public/../application/h5/view/vipcard/card_buy.html";i:1558499248;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="mui-content mui-scroll-wrapper mui-button" id="pullrefresh">
    <div class="mui-scroll">
        ...
        <div class="mui-table-view mui-table-view-chevron  card_dd " style='margin-top:20px' >
            <form class="mui-input-group">
                ...
                <div class="mui-ddan" style="margin-top: 10px;">
                    ...
                    <div class="dd_center">
                        <p class="price">支付方式：<span  class='mui-blue mui-pull-right' style="color: #2992ff;text-align: right;width: 80px;">支付宝 </span></p>
						
                        <input type="hidden" name="pay_method" id="pay_type" value="1">
                    </div>
                </div>
    ...
    $('button.mui-btns')[0].addEventListener('tap',function(){
        ...
        $.ajax({
            ...
            success:function (res) {
                ...
                if (res.code == 1){
                    mui.toast(res.msg);
                    location.href="<?php echo url('paySelect'); ?>?"+"order_number="+res.data.order_number;
