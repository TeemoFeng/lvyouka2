...
* 
**/
require_once EXTEND_PATH."/pay/lib/WxPay.Api.php";
...
class JsApiPay
{
	...
	public function GetOpenid()
	{
		...
		if (!isset($_GET['code'])){
            ...
            //报这个错,未定义数组索引: openid 把源文件注释换成下面代码
//			//获取code码，以获取openid
		    $code = $_GET['code'];
			$openid ='oA8aR1lls2g9oaa2SUe0r-9QBLHg';
			return $openid;
            //下面代码
...
//        报错Undefined property: JsApiPay::$curl_timeout,把$this->curl_timeout改为30
