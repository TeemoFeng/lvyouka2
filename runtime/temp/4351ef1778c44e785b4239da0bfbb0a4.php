<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:91:"/www/wwwroot/lv.wyc168.com/public/../application/wycadmin/view/power/permission_access.html";i:1558140108;s:71:"/www/wwwroot/lv.wyc168.com/application/wycadmin/view/public/header.html";i:1555747040;s:69:"/www/wwwroot/lv.wyc168.com/application/wycadmin/view/public/menu.html";i:1555747004;s:75:"/www/wwwroot/lv.wyc168.com/application/wycadmin/view/public/headerInfo.html";i:1556608616;s:75:"/www/wwwroot/lv.wyc168.com/application/wycadmin/view/public/pageHeader.html";i:1547777422;s:73:"/www/wwwroot/lv.wyc168.com/application/wycadmin/view/public/dropDown.html";i:1547739334;s:71:"/www/wwwroot/lv.wyc168.com/application/wycadmin/view/public/footer.html";i:1555746880;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content clearfix">
                            <form action="" id="power" method="POST" class="form-horizontal auth-form">
                                <?php if(is_array($prowerListOne) || $prowerListOne instanceof \think\Collection || $prowerListOne instanceof \think\Paginator): $i = 0; $__LIST__ = $prowerListOne;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <div class="rule_check">
                                    <div>
                                        <label class="checkbox inline">
                                            <input class="auth_rules rules_row" type="checkbox" name="rules[]" value="<?php echo $vo->id; ?>" <?php if($vo->check): ?> checked="checked" <?php endif; ?>><?php echo $vo->title; ?>
                                        </label>
                                    </div>
                                    <!--<span class="divsion">&nbsp;</span>-->
                                    <?php if(is_array($vo->sonOne) || $vo->sonOne instanceof \think\Collection || $vo->sonOne instanceof \think\Paginator): $i = 0; $__LIST__ = $vo->sonOne;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?>
                                    <span class="child_row">
                                            <label class="checkbox inline" data-hasqtip="64" oldtitle="新增编辑和保存配置" title="">
                                                <input class="auth_rules" type="checkbox" name="rules[]" value="<?php echo $voo->id; ?>" <?php if($voo->check): ?> checked="checked" <?php endif; ?>><?php echo $voo->title; ?>
                                            </label>
                                    </span>
                                    <p  style="margin-left: 30px">
                                        <?php if(is_array($voo->sonTwe) || $voo->sonTwe instanceof \think\Collection || $voo->sonTwe instanceof \think\Paginator): $i = 0; $__LIST__ = $voo->sonTwe;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vooo): $mod = ($i % 2 );++$i;?>
                                        <label class="checkbox inline" data-hasqtip="64" oldtitle="新增编辑和保存配置" title="">
                                            <input class="auth_rules" type="checkbox" name="rules[]" value="<?php echo $vooo->id; ?>" <?php if($vooo->check): ?> checked="checked" <?php endif; ?>><?php echo $vooo->title; ?>
                                        </label>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </p>
                                    <!--<br>-->
                                ...
                                <div class="form-actions">
                                    <input type="hidden" name="power_id" value="<?php echo $powerId; ?>">
