                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-body">
                            <a href="<?php echo url('power/poweradd'); ?>" class="btn  btn-success">新增</a>
                            ...
                            <div class="table-responsive">
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        ...
                                        <tbody>
                                        <?php if(is_array($powerList) || $powerList instanceof \think\Collection || $powerList instanceof \think\Paginator): $i = 0; $__LIST__ = $powerList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr class="gradeA odd" role="row">
                                            <td><input type="checkbox" class="shell-check Keys" Key="<?php echo $vo->id; ?>" /></td>
                                            <td ><a href="bianji-yonghuzu.html"><?php echo $vo->title; ?></a></td>
                                            <td><?php echo $vo->content; ?></td>
                                            <td><a href="<?php echo url('power/permissionAccess',['powerId'=>$vo->id]); ?>">访问授权</a></td>
                                            <td><?php echo $vo->status; ?></td>

                                            <td>
                                                <a href="<?php echo url('power/poweredit',['id'=>$vo->id]); ?>" class="btn btn-sm btn-success">编辑</a>
                                                <a href="javascript:;" onclick="enable(<?php echo $vo->id; ?>)" class="btn  btn-primary btn-sm">启用</a>
                                                <a href="javascript:;" onclick="padding(<?php echo $vo->id; ?>)" class="btn  btn-info btn-sm">禁用</a>
                                                <a href="javascript:;" onclick="deletes(<?php echo $vo->id; ?>)" class="btn  btn-danger btn-sm">删除</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </tbody>
...
highlight_subnav();
    ...
    function deletes(key = '') {
        modifyByKeys("<?php echo url('power/powerDelete'); ?>",key)
    }

    function padding(key = '') {
        modifyByKeys("<?php echo url('power/powerPadding'); ?>",key)
    }

    function enable(key = '') {
        modifyByKeys("<?php echo url('power/powerEnable'); ?>",key)
    }
</script>
