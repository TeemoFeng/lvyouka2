                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-body">
                            <a href="<?php echo url('admin/adminadd'); ?>" class="btn  btn-success">新增</a>
                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td><?php echo $vo->logins; ?></td>
                                            <td><?php echo $vo->last_login_time; ?></td>
                                            <td><a href="http://ip138.com/ips138.asp?ip=127.0.0.1">	<?php echo $vo->last_login_ip; ?></a></td>
                                            <td><?php echo $vo->status; ?></td>
                                            <td>
                                                <a href="<?php echo url('admin/adminedit',['id'=>$vo->id]); ?>" class="btn btn-sm btn-success">编辑</a>
...
highlight_subnav();
    function highlight_subnav() {
        ...
        $($('.metismenu li ').find('a[href="/wycadmin/admin/adminlist"]')).parent().addClass('active');
      
       $($('.metismenu li ').find('a[href="/wycadmin/admin/adminlist"]')).parent().parent().parent().addClass('active');
    }
    function deletes(key = '') {
        modifyByKeys("<?php echo url('admin/adminDelete'); ?>",key)
    }

    function padding(key = '') {
        modifyByKeys("<?php echo url('admin/adminPadding'); ?>",key)
    }

    function enable(key = '') {
        modifyByKeys("<?php echo url('admin/adminEnable'); ?>",key)
    }
</script>
