                            ...
                            <form method="post" id="newsinfo" class="form-horizontal col-lg-6"
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*景点类型</label>
                                    <div class="col-sm-10"><select name="category_id" class="form-control">
                                        ...
                                        <?php if(is_array($category_list) || $category_list instanceof \think\Collection || $category_list instanceof \think\Paginator): $i = 0; $__LIST__ = $category_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$reg): $mod = ($i % 2 );++$i;?>
                                        <option value="<?php echo $reg['id']; ?>" <?php if($reg['id'] == $info->category_id): ?>selected <?php endif; ?> ><?php echo str_repeat('&nbsp;&nbsp;',$reg['level']); ?>└<?php echo $reg['title']; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    </div>
                                </div>
