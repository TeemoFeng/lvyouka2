...
<style type="text/css">
    ...
    <link rel="stylesheet" type="text/css" href="/static/admin/js/time/datepicker3.css"/>
</head>
                    ...
                    <form action="" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-6 col-xs-12 " >
                                ...
                                <option value="mobile" <?php if(\think\Request::instance()->get('searchType') == 'mobile'): ?> selected <?php endif; ?>>手机号</option>
                                <option value="username" <?php if(\think\Request::instance()->get('searchType') == 'username'): ?> selected <?php endif; ?>>用户名</option>
                            </select>
                            </div>
                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" >
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td><?php echo $vo->w_parent_id; ?></td>
                                            <td><?php echo $vo->team_count; ?></td>
                                            <td><?php echo $vo->zt_count; ?></td>
...
<script src="/static/admin/js/time/moment.min.js" type="text/javascript" charset="utf-8"></script>
<script src="/static/admin/js/time/daterangepicker.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript">
    ...
    function padding(key = '') {
        layer.prompt({title: '输入封禁原因', formType: 2}, function(pass, index){
            ...
            ajax_Submit("<?php echo url('member/memberPadding'); ?>",data,'post')
            layer.close(index);
        });
    }
