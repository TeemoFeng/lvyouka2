                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content clearfix">
                            <form method="post" id="menuinfo"  class="form-horizontal col-lg-6">
                                <div class="form-group"><label class="col-sm-2 control-label">*菜单名</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" value="<?php echo $menuInfo->title; ?>" name="title"></div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">*父级菜单</label>

                                    <div class="col-sm-10"><select name="parent_id" id="" class="form-control">
                                        ...
                                        <option value="<?php echo $vo['id']; ?>" <?php if($menuInfo->parent_id==$vo['id']): ?> selected <?php endif; ?>><?php echo str_repeat('&nbsp;&nbsp;',$vo['level']); ?>└<?php echo $vo['title']; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select><span class="help-block m-b-none text-danger">(菜单只显示两级)</div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*控制器名</label>
                                    <div class="col-sm-10"><input type="text" name="controller" value="<?php echo $menuInfo->controller; ?>" class="form-control"> </span>
                                    </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*方法名</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" value="<?php echo $menuInfo->action; ?>" class="form-control" name="action"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">排序</label>
                                    <div class="col-sm-10"><input type="tel" value="<?php echo $menuInfo->sort; ?>" class="form-control" name="sort"></div>
                                </div>
                                <input type="hidden" name="id" value="<?php echo $menuInfo->id; ?>">
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">是否显示</label>
                                    <div class="col-sm-10">
                                        <input type="checkbox" class="form-control"  name="status"
                                               <?php if($menuInfo->status): ?> checked="checked <?php endif; ?>" value="1">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
...
<script type="text/javascript">
   ...
   highlight_subnav();
    ...
    function infoSubmit() {
        ajax_Submit("",$('#menuinfo').serialize(),"post");
    }
</script>
