                ...
                <div class="col-lg-12">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content clearfix">
                            <form method="post" id="power" class="form-horizontal col-lg-6">
                                <div class="form-group"><label class="col-sm-2 control-label">用户组</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" name="title" value="<?php echo $powerInfo->title; ?>"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">描述</label>
                                    <div class="col-sm-10"><textarea  class="form-control" name="content"><?php echo $powerInfo->content; ?></textarea>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <button class="btn btn-primary" type="button" onclick="powerSubmit()">保存更改</button>
                                    </div>
                                </div>
                            </form>
                        </div>
