<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"/www/wwwroot/lv.wyc168.com/public/../application/h5/view/user/index.html";i:1558226906;s:65:"/www/wwwroot/lv.wyc168.com/application/h5/view/public/header.html";i:1558149238;s:62:"/www/wwwroot/lv.wyc168.com/application/h5/view/public/nav.html";i:1558364049;s:65:"/www/wwwroot/lv.wyc168.com/application/h5/view/public/footer.html";i:1558340461;}*/ ?>
<html>
<head>
    <meta charset="utf-8">
				...
				<div class="mui-table-view mui-table-view-chevron mui-index user   mui-bottom" >
					<div class="user_header">
						<div class="flex">
							...
							<img src="<?php echo $userInfo->wx_header_image; ?>" alt="">
					...
					<div class="user_center">
						...
						<ul class="mui-list-unstyled mui-clearfix">
							...
							<li>
								<a href="<?php echo url('user/infoBind'); ?>">
									<img src="/static/h5/images/wode/shimingrenzheng.png" alt="">
									<p>信息完善</p>
								</a>
							</li>
                           ...
                           <li>
								<a href="<?php echo url('user/userAbout'); ?>">
...
<script src="/static/h5/js/ajax_Submit.js" type="text/javascript" charset="utf-8"></script> 
		...
		$('#dianji')[0].addEventListener('tap',function(){
        	 mui.toast("请先成为正式会员")
