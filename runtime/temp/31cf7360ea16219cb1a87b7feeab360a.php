                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-body">
                            <a href="<?php echo url('banner/banneradd',['pid'=>$pid]); ?>" class="btn  btn-success">新增</a>
                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <!--<td><?php echo $vo->sc_id; ?></td>-->
                                            <td><img src="<?php echo $vo->w_image_path; ?>" alt="" height="40" width="40"></td>
                                            <td><?php echo $vo->create_time; ?></td>
                                            <td><?php echo $vo->update_time; ?></td>
                                            <td><?php echo $vo->w_status; ?></td>
                                            <td>
                                                <a href="<?php echo url('banner/banneredit',['id'=>$vo->id]); ?>}}" class="btn btn-sm btn-success">编辑</a>
...
<script type="text/javascript">
    ...
    function updateStatus(key = '',status = 1) {
        modifyByKeys("<?php echo url('banner/bannerStatusUpdate'); ?>",key,status)
    }
  highlight_subnav();
