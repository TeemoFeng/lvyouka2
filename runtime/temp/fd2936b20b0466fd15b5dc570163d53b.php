                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-body">
                            <a href="<?php echo url('waiter/waiteradd'); ?>" class="btn  btn-success">新增</a>
                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td><?php echo $vo->kf_num; ?></td>
                                            <td><?php echo $vo->create_time; ?></td>
                                            <td><?php echo $vo->w_status; ?></td>
                                            <td>
                                                <a href="<?php echo url('waiter/waiteredit',['id'=>$vo->id]); ?>" class="btn btn-sm btn-success">编辑</a>
...
<script type="text/javascript">
    ...
    function updateStatus(key = '',status = 1) {
        modifyByKeys("<?php echo url('waiter/waiterStatusUpdate'); ?>",key,status)
    }
   highlight_subnav();
    function highlight_subnav() {
		
        $($('.metismenu li ').find('a[href="/wycadmin/waiter/waiterlist"]')).parent().addClass('active');
      
       $($('.metismenu li ').find('a[href="/wycadmin/waiter/waiterlist"]')).parent().parent().parent().addClass('active');
    }
</script>
