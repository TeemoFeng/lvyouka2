                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-body">
                            <a href="<?php echo url('system/menuadd',['parentId'=>$parentId]); ?>" class="btn  btn-success">新增</a>
                            ...
                            <div class="table-responsive">
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        ...
                                        <tbody>
                                    <?php if(is_array($menuListPage) || $menuListPage instanceof \think\Collection || $menuListPage instanceof \think\Paginator): $i = 0; $__LIST__ = $menuListPage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr class="gradeA odd" role="row">
                                            <td><input type="checkbox" class="shell-check Keys" Key="<?php echo $vo->id; ?>" /></td>
                                            <td ><?php echo $vo->id; ?></td>
                                            <td><?php echo $vo->title; ?></td>
                                            <td><?php echo $vo->fatherTitle; ?></td>
                                            ...
                                            <!--<td>0</td>-->
                                            <td>
                                                <a href="?parentId=<?php echo $vo->id; ?>" class="btn btn-sm btn-warning">查看子菜单</a>
                                                <a href="<?php echo url('system/menuedit',['id'=>$vo->id]); ?>" class="btn btn-sm btn-success">编辑</a>
                                                <a href="javascript:;" onclick="enable(<?php echo $vo->id; ?>)" class="btn btn-sm  btn-primary">启用</a>
                                                <a href="javascript:;" onclick="padding(<?php echo $vo->id; ?>)" class="btn btn-sm  btn-info">禁用</a>
                                                <a href="javascript:;" onclick="deletes(<?php echo $vo->id; ?>)" class="btn btn-sm btn-danger">删除</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </tbody>
...
<script type="text/javascript">
    ...
    function deletes(key = '') {
        modifyByKeys("<?php echo url('system/menuDelete'); ?>",key)
    }
     highlight_subnav();
    ...
    function padding(key = '') {
        modifyByKeys("<?php echo url('system/menuPadding'); ?>",key)
    }

    function enable(key = '') {
        modifyByKeys("<?php echo url('system/menuEnable'); ?>",key)
    }
</script>
