<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/www/wwwroot/lv.wyc168.com/public/../application/h5/view/vipcard/card_active.html";i:1558339919;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
		...
		<div class="mui-table-view mui-table-view-chevron  jihuo_card " >
			<form class="mui-input-group">
				...
				<?php endif; ?>
              	...
              	<input type="hidden" id='zhuang'  value="<?php echo $bind; ?>">
...
<script type="text/javascript" charset="utf-8">
    ...
    $('button.mui-btns')[0].addEventListener('tap',function(){
      	if($('#zhuang').val()==0){
				 mui.toast('请先完善资料')
				  setTimeout(function () {
					location.href = "<?php echo url('user/infoBind'); ?>?from=1";
				  },1000)
			  return false;
			}
