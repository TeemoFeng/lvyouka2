                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content clearfix">
                            <form method="post" id="admininfo" class="form-horizontal col-lg-6">
                                <div class="form-group"><label class="col-sm-2 control-label">*管理员名</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" name="username" value="<?php echo $adminInfo->username; ?>"><span class="help-block m-b-none text-danger">(管理员名最短6位,最长20位)</span></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">权限</label>

                                    <div class="col-sm-10"><select name="power" class="form-control">
                                        <option value="0">最高权限</option>
                                        <?php if(is_array($powerList) || $powerList instanceof \think\Collection || $powerList instanceof \think\Paginator): $i = 0; $__LIST__ = $powerList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$po): $mod = ($i % 2 );++$i;?>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">密码</label>
                                    <div class="col-sm-10"><input type="password" class="form-control"  placeholder="不修改密码请留空" name="password"> <span class="help-block m-b-none text-danger">(密码最短6位,最长20位)</span>
                                    </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">确认密码</label>
                                    ...
                                    <div class="col-sm-10"><input type="password" class="form-control" placeholder="不修改密码请留空" name="password_confirm"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
...
highlight_subnav();
    function highlight_subnav() {
        ...
        $($('.metismenu li ').find('a[href="/wycadmin/Admin/adminAdd"]')).parent().addClass('active');
      
       $($('.metismenu li ').find('a[href="/wycadmin/Admin/adminAdd"]')).parent().parent().parent().addClass('active');
    }
    function infoSubmit() {
        ajax_Submit("",$('#admininfo').serialize(),"post");
    }
</script>
