                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td><?php echo $vo->getScenic->title; ?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo url('special/specialedit',['id'=>$vo->id]); ?>" class="btn btn-sm btn-success">编辑</a>
...
<script type="text/javascript">
    ...
    function updateStatus(key = '',status = 1) {
        modifyByKeys("<?php echo url('special/specialStatusUpdate'); ?>",key,status)
    }
   highlight_subnav();
    function highlight_subnav() {
		
        $($('.metismenu li ').find('a[href="/wycadmin/special/speciallist"]')).parent().addClass('active');
      
       $($('.metismenu li ').find('a[href="/wycadmin/special/speciallist"]')).parent().parent().parent().addClass('active');
    }
</script>
